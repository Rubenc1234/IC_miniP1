...
Este relatório documenta o desenvolvimento e os resultados obtidos no âmbito do Trabalho Laboratorial nº 2 da cadeira de Informação e Codificação.
...
A operação de negativo consiste em inverter os valores de intensidade de cada canal de cor de uma imagem. 
