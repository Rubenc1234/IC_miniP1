...
O código-fonte completo do projeto está disponível publicamente no seguinte repositório GitHub: \url{LINK_PARA_O_VOSSO_REPOSITORIO}. % <--- SUBSTITUIR LINK AQUI
...
% Adicionar aqui a Figura com os resultados (original e os 3 canais extraídos)
% \begin{figure}[htbp]
% \centering
% \includegraphics[width=0.4\textwidth]{caminho/para/imagem_original.png} \hfill
% \includegraphics[width=0.4\textwidth]{caminho/para/canal_azul.png} \\
% \includegraphics[width=0.4\textwidth]{caminho/para/canal_verde.png} \hfill
% \includegraphics[width=0.4\textwidth]{caminho/para/canal_vermelho.png}
...
% Adicionar Figura: Original vs Negativo
...
% Adicionar Figura: Original vs Espelhada H vs Espelhada V
% \begin{figure}[htbp] ... \end{figure}
...
% Adicionar Figura: Original vs Rotação 90 vs Rotação 180 vs Rotação 270
% \begin{figure}[htbp] ... \end{figure}
...
% Adicionar Figura: Original vs Brilho +50% vs Brilho -50%
% \begin{figure}[htbp] ... \end{figure}
