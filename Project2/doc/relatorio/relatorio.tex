...
\begin{itemize}
    \item \textbf{Competitividade com PNG:} O nosso codec conseguiu superar o standard PNG na imagem \texttt{airplane} (130kB vs 138kB) e obteve um empate técnico na imagem \texttt{bike3} (diferença de apenas 3kB). Na imagem \texttt{arial} (texto/gráficos), o PNG obteve uma ligeira vantagem.
