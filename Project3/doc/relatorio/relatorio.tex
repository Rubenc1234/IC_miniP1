...
\begin{table}[H]
    ...
    \begin{tabular}{lcccccc}
        ...
        & Fast & 943 MB & 634 MB & 1.487:1 & 9.1 s & 9.9 s \\
        & Best & 943 MB & 632 MB & 1.491:1 & 14.2 s & 12.5 s \\
        \midrule
        \multirow{2}{*}{\texttt{model\_1.safetensors}} 
        & Fast & 453 MB & 375 MB & 1.209:1 & 4.0 s & 5.3 s \\
        & Best & 453 MB & 373 MB & 1.216:1 & 6.6 s & 5.7 s \\
        \midrule
        \multirow{2}{*}{\texttt{model\_2.safetensors}} 
        & Fast & 583 MB & 494 MB & 1.182:1 & 5.1 s & 7.1 s \\
        & Best & 583 MB & 493 MB & 1.184:1 & 8.4 s & 7.4 s \\
        \midrule
        \multirow{2}{*}{\texttt{model\_3.safetensors}} 
        & Fast & 2.1 GB & 1.41 GB & 1.490:1 & 17.7 s & 39.1 s \\
        & Best & 2.1 GB & 1.40 GB & 1.495:1 & 30.6 s & 42.1 s \\
        \midrule
        \multirow{2}{*}{\texttt{model\_4.safetensors}} 
        & Fast & 3.9 GB & 3.51 GB & 1.120:1 & 35.8 s & 77.4 s \\
        & Best & 3.9 GB & 3.51 GB & 1.121:1 & 67.0 s & 52.6 s \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{lccc}
        ...
        \midrule
        \textbf{Codec (Fast)} & 1.49:1 & 9.1 s & 9.9 s \\
        \textbf{Codec (Best)} & 1.49:1 & 14.2 s & 12.5 s \\
        \bottomrule
    \end{tabular}
\end{table}
...
O codec desenvolvido \textbf{superou todos os compressores de uso geral testados}, atingindo um rácio de 1.49:1 no modelo principal, comparado com 1.44:1 do melhor compressor genérico (BZIP2). Esta melhoria de 3.5\% representa uma poupança adicional de aproximadamente 310 MB no ficheiro de 943 MB.
...
\begin{itemize}
    \item \textbf{\texttt{model.safetensors}}: Rácio elevado ($\approx$ 1.49:1);
    \item \textbf{\texttt{model\_1/2/3.safetensors}}: Rácio moderado ($\approx$ 1.18--1.21:1);
    \item \textbf{\texttt{model\_4.safetensors}}: Rácio reduzido ($\approx$ 1.12:1).
\end{itemize}
...
\begin{itemize}
    \item \textbf{Modo Fast}: Para o modelo principal (\texttt{model.safetensors}), a codificação foi concluída em 9.1~s e a descodificação em 9.9~s;
    \item \textbf{Modo Best}: A codificação aumentou para 14.2~s e a descodificação para 12.5~s, proporcionando uma melhoria marginal na taxa de compressão.
\end{itemize}
...
\begin{tabular}{lcccc}
\hline
\textbf{Modelo} & \textbf{BEST Cod. (MB)} & \textbf{BEST Dec. (MB)} & \textbf{FAST Cod. (MB)} & \textbf{FAST Dec. (MB)} \\
\hline
model\_1 & 6696 & 6840 & 6588 & 6348 \\
model\_2 & 6520 & 6916 & 6540 & 6164 \\
model\_3 & 6360 & 6212 & 6404 & 6160 \\
model & 6368 & 6216 & 6416 & 6300 \\
model\_4 & 6684 & 6728 &  6724 &  6364 \\
\hline
\end{tabular}
...
\begin{itemize}
    \item \texttt{model.safetensors} (943~MB): 9.1~s de codificação e 9.9~s de descodificação (Fast);
    \item \texttt{model\_4.safetensors} (3.9~GB): 35.8~s de codificação e 77.4~s de descodificação (Fast).
\end{itemize}

Apesar do aumento absoluto dos tempos, o \textit{throughput} mantém-se da mesma ordem de grandeza, variando aproximadamente entre 51 e 111~MB/s, o que demonstra boa escalabilidade do codec para modelos de maior dimensão.
